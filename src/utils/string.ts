...
const canMove = (iter: IterationStringProps) => (iter.step > 0 ? iter.idx + iter.step < iter.s.length + 1 : iter.idx + iter.step > -2) && !iter.break && (iter.iterationCount === undefined || iter.iterationCount < 100)
